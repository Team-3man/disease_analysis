...
| 양희준 | 이번 EDA 프로젝트로 데이터 전처리부터 시각화까지 전체 흐름을 이해하는데 도움이 되었습니다. <br> 처음에 코로나 확진 여부나 백신 접종 여부에 따라 건강 지표가 뚜렷하게 나올 것이라고 예상했는데, 실제 데이터 다뤄보니 달라서 기본 작업을 좀 더 세밀하게 해야겠다 생각 들었습니다.  |
